...
class hplStrategy():
    def __init__(self, T, ds, N_mpc, dt, fint, s_conf_thresh, ey_conf_thresh, map, retrain_flag):
        ...
        if retrain_flag:
            ...
            self.s_model = pickle.load(open('/home/bruce/PycharmProjects/barc_ros_ws/src/barc/src/AE:BE:US/s_model.pkl','rb'))
            self.s_model.double()
            self.s_model.eval()
            self.s_likelihood = pickle.load(open('/home/bruce/PycharmProjects/barc_ros_ws/src/barc/src/AE:BE:US/s_likelihood.pkl','rb'))
            self.s_likelihood.eval()
            self.ey_model = pickle.load(open('/home/bruce/PycharmProjects/barc_ros_ws/src/barc/src/AE:BE:US/ey_model.pkl','rb'))
            self.ey_model.double()
            self.ey_model.eval()
            self.ey_likelihood = pickle.load(open('/home/bruce/PycharmProjects/barc_ros_ws/src/barc/src/AE:BE:US/ey_likelihood.pkl','rb'))
