...
(cl:defmethod cl:initialize-instance :after ((m <input>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'input)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name barc-msg:<input> is deprecated: use barc-msg:input instead.")))

(cl:ensure-generic-function 'accel-val :lambda-list '(m))
(cl:defmethod accel-val ((m <input>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader barc-msg:accel-val is deprecated.  Use barc-msg:accel instead.")
  (accel m))

(cl:ensure-generic-function 'steer-val :lambda-list '(m))
(cl:defmethod steer-val ((m <input>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader barc-msg:steer-val is deprecated.  Use barc-msg:steer instead.")
  (steer m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<input>)))
  ...
  "be360b2b21a0fff5bfe4192d75a591ef")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'input)))
  "Returns md5sum for a message object of type 'input"
  "be360b2b21a0fff5bfe4192d75a591ef")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<input>)))
  ...
  (cl:format cl:nil "float64 accel~%float64 steer~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'input)))
  "Returns full string definition for message of type 'input"
  (cl:format cl:nil "float64 accel~%float64 steer~%~%"))
